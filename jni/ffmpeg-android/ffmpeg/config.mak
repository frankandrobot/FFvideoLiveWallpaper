...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --arch=arm --cross-prefix=arm-linux-androideabi- --arch=arm --sysroot=/docs/android/android-ndk-r6//platforms/android-3/arch-arm --soname-prefix=/data/data/ffvideolivewallpaper.frankandrobot.com/lib/ --disable-ffmpeg --disable-ffplay --disable-ffserver --disable-ffprobe --disable-encoders --disable-muxers --disable-devices --disable-protocols --enable-protocol=file --enable-avfilter --disable-network --disable-avdevice --disable-asm --enable-shared --disable-symver --enable-small --disable-doc --optimization-flags=-O2 --prefix=../build/ffmpeg/armeabi-v7a --extra-cflags='-march=armv7-a -mfloat-abi=softfp' --extra-ldflags=
...
SONAME_PREFIX=/data/data/ffvideolivewallpaper.frankandrobot.com/lib/
SRC_PATH="/home/uri/projects/FFvideoLiveWallpaper/jni/ffmpeg-android/ffmpeg"
SRC_PATH_BARE=/home/uri/projects/FFvideoLiveWallpaper/jni/ffmpeg-android/ffmpeg
BUILD_ROOT="/home/uri/projects/FFvideoLiveWallpaper/jni/ffmpeg-android/ffmpeg"
...
CPPFLAGS= --sysroot=/docs/android/android-ndk-r6//platforms/android-3/arch-arm -D_ISOC99_SOURCE -D_POSIX_C_SOURCE=200112 -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DPIC
